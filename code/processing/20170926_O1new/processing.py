...
operator = np.array(['O1new201','O1new204','O1new205','O1new207','O1new208','O1new209',\
          'O1new210','O1new211'])
energy = np.array([-14.99, -14.30, -12.48, -14.56, -12.40, -11.64,\
                   -11.24, -14.05])
...
for i, op in enumerate(operator):
    for j, strain in enumerate(rbs):
        ...
        try:
            ...
            r_file = glob.glob(datadir + str(date) +  '_' + run + '*'+ op + '_' + strain + '.csv')
            print(r_file)
            # read the csv file
...
# write
df.to_csv('output/' + str(date) + '_' + run + '_' + 'O1new' + \
...
with open('../../../data/' + str(date) + '_' + run + '_' + 'O1new' + \
